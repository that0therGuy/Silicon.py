    ...
    extraKeys: {
        "F10": function(cm) {
            ...
            if (localStorage.getItem('bg')==1){
                document.querySelector('.CodeMirror').style.setProperty('background-image', "url('Images/space.jpg')", 'important');
                ...
                document.querySelector('.CodeMirror').style.setProperty('background-image', "url('Images/xp.jpg')", 'important');
                document.querySelector('.CodeMirror').style.setProperty('background-size', "cover", 'important');
                ...
                document.querySelector('.CodeMirror').style.setProperty('background-image', "url('Images/city.jpg')", 'important');
                document.querySelector('.CodeMirror').style.setProperty('background-size', "cover", 'important');
                ...
                document.querySelector('.CodeMirror').style.setProperty('background-image', "url('Images/forest.jpg')", 'important');
                document.querySelector('.CodeMirror').style.setProperty('background-size', "cover", 'important');
...
`;
        ...
        css = `
    .CodeMirror {
    background-image: url('Images/xp.jpg') !important;
    background-size: cover !important;
}
`;
    } else if (bg == '5') {
